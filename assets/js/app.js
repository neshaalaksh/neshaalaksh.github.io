...
<a class="navbar-brand" href="index.html">Neshaa Lakshmniarayanna </a>
      ...
      <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
        <p class="tag" >"If you want it, create it."
          ...
          <div class="rounded-social-buttons tag">
            <a class="social-button twitter" href="https://twitter.com/neshaalaksh" target="_blank">
           ...
           <a class="social-button linkedin" href="https://www.linkedin.com/in/neshaa-lakshminarayanan-9185671b0" target="_blank" >
           <!-- svg code for linkedin icon -->
            ...
            <a class="social-button instagram" href="https://www.instagram.com/neshaa.laksh" target="_blank" >
            ...
            <a class="social-button github" href="https://github.com/neshaalaksh" target="_blank">
